...
function Clock() {
    ...
    const stringTime =   `${date.getHours()}:${ date.getMinutes() < 10 ? '0' + date.getMinutes() :date.getMinutes() }:${date.getSeconds() < 10 ? '0' + date.getSeconds() :date.getSeconds()}` || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    ...
    return (
        <div className={s.clock}>
            <div
                id="hw9-watch"
                className={`${s.watch} ${show ? s.watchHover : ''}`}
        ...
        <strong>{stringTime}</strong>
            ...
            <div id="hw9-more" className={s.moreContainer}>
                <div className={`${s.more} ${show ? s.moreShow : ''}`}>
                    {show ? (
                        <>
